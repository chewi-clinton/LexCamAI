...
const LAW_PORTALS = [
  {
    title: 'OHADA — Acte Commercial Général',
    url: 'https://www.ohada.com/telechargement/actes-uniformes/AUDCG-2010_fr.pdf',
    code: 'ohada-audcg',
    name: 'Acte Uniforme OHADA — Droit Commercial Général (2010)',
    domain: 'commercial',
    language: 'fr',
    desc: 'PDF officiel OHADA — ingestion directe dans la base de connaissances',
  },
  {
    title: 'OHADA — Sociétés Commerciales',
    url: 'https://www.ohada.com/telechargement/actes-uniformes/AUSCGIE-2014_fr.pdf',
    code: 'ohada-auscgie',
    name: 'Acte Uniforme OHADA — Sociétés Commerciales et GIE (2014)',
    domain: 'commercial',
    language: 'fr',
    desc: 'PDF officiel OHADA — droit des sociétés',
  },
  {
    title: 'OHADA — Procédures Collectives',
    url: 'https://www.ohada.com/telechargement/actes-uniformes/AUPCAP-2015_fr.pdf',
    code: 'ohada-aupcap',
    name: 'Acte Uniforme OHADA — Procédures Collectives (2015)',
    domain: 'commercial',
    language: 'fr',
    desc: 'PDF officiel OHADA — insolvabilité et redressement judiciaire',
  },
  {
    title: 'OHADA — Sûretés',
    url: 'https://www.ohada.com/telechargement/actes-uniformes/AUS-2010_fr.pdf',
    code: 'ohada-aus',
    name: 'Acte Uniforme OHADA — Sûretés (2010)',
    domain: 'commercial',
    language: 'fr',
    desc: 'PDF officiel OHADA — garanties et sûretés',
  },
  {
    title: 'OHADA — Arbitrage',
    url: 'https://www.ohada.com/telechargement/actes-uniformes/AUA-2017_fr.pdf',
    code: 'ohada-aua',
  ...
  },
  {
    ...
    url: 'https://www.ohada.com/telechargement/actes-uniformes/AUPSRVE-2023_fr.pdf',
    code: 'ohada-aupsrve',
