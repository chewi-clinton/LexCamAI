...
def test_list_jobs_empty():
    ...
    r = _client.get("/api/v1/scraper/scrape")
...
def test_get_job():
    ...
    app.dependency_overrides[get_session] = lambda: (yield s)
    r = _client.get("/api/v1/scraper/scrape/1")
    app.dependency_overrides.clear()
    assert r.status_code == 200
...
def test_get_job_not_found():
    ...
    app.dependency_overrides[get_session] = lambda: (yield s)
    r = _client.get("/api/v1/scraper/scrape/999")
    app.dependency_overrides.clear()
...
def test_create_job():
    ...
    with patch("app.tasks.run_scrape_async.delay"):
        r = _client.post("/api/v1/scraper/scrape", json={"url": "https://example.com"})
    app.dependency_overrides.clear()
...
def test_list_law_jobs_empty():
    ...
    s.exec.return_value.all.return_value = []
    app.dependency_overrides[get_session] = lambda: (yield s)
    r = _client.get("/api/v1/scraper/scrape-laws")
    app.dependency_overrides.clear()
    assert r.status_code == 200
    assert r.json() == []
...
def test_get_law_job():
    ...
    app.dependency_overrides[get_session] = lambda: (yield s)
    r = _client.get("/api/v1/scraper/scrape-laws/1")
    app.dependency_overrides.clear()
    assert r.status_code == 200
...
def test_get_law_job_not_found():
    ...
    s.get.return_value = None
    app.dependency_overrides[get_session] = lambda: (yield s)
    r = _client.get("/api/v1/scraper/scrape-laws/999")
    app.dependency_overrides.clear()
    assert r.status_code == 404
...
def test_create_law_job():
    ...
    with patch("app.tasks.run_law_scrape.delay"):
        r = _client.post("/api/v1/scraper/scrape-laws", json={
